...
public class NotificationUtils {
    ...
    /*
     * the notification ID can be used to access our notification we've displayed it.
     * This can be handy when we need to cancel the notification, or perhaps update it.
     */
    private static final int WATER_REMINDER_NOTIFICATION_ID = 1625;

    /*
     * this pending intent id is used to uniquely reference the pending intent
     */
    private static final int WATER_REMINDER_PENDING_INTENT_ID = 1626;
