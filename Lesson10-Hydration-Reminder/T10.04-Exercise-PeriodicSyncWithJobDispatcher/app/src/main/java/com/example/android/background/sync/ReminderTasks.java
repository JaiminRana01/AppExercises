...
public class ReminderTasks {
    ...
    public static final String ACTION_CHARGING_REMINDER = "charging-remider";
    ...
    public static void executeTask(Context context, String action) {
        if (ACTION_INCREMENT_WATER_COUNT.equals(action)) {
            ...
            issueChargingRemider(context);
        }
    }

    private static void issueChargingRemider(Context context) {
